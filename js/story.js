const sectionData = {
    ...
    "story-characters": [
        ...
        "La serie incluye además un nutrido grupo de personajes secundarios: compañeros de trabajo,profesores, otros familiares, amigos de la familia, gela ciudad y estrellas locales. Según Matt Groening, la serie tomó la idea de incluir un gran reparto de la telecomedia canadiense SecondCity Television.",
    ],
    scenery: [
